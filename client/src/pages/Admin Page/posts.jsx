          ...
          {activeSection === "testimonies" && (
            <form onSubmit={handleTestimonySubmit} className="space-y-6 max-w-4xl mx-auto">
              ...
              <div className="flex gap-4 pt-4">
                <button
                  type="submit"
                  className="flex-grow bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-bold py-4 rounded-xl shadow-lg transition-all duration-300 focus:ring-4 focus:ring-purple-400 transform hover:scale-105"
                  disabled={loading}
                >
                  {loading ? "Processing..." : (editingId ? "Update Testimony" : "Create Testimony")}
                </button>
                {editingId && (
                  <button
                    type="button"
          ...
          {activeSection === "feedbacks" && (
            <form onSubmit={handleFeedbackSubmit} className="space-y-6 max-w-4xl mx-auto">
              ...
              <div className="flex gap-4 pt-4">
                <button
                  type="submit"
                  className="flex-grow bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white font-bold py-4 rounded-xl shadow-lg transition-all duration-300 focus:ring-4 focus:ring-orange-400 transform hover:scale-105"
                  disabled={loading}
                >
                  {loading ? "Processing..." : (editingId ? "Update Feedback" : "Create Feedback")}
                </button>
                {editingId && (
                  <button
                    type="button"
